...
class TicketsListView extends StatelessWidget {
  final ValueNotifier<List<EventTicket>> ticketsNotifier;

  const TicketsListView({super.key, required this.ticketsNotifier});

  @override
  Widget build(BuildContext context) {
    return ValueListenableBuilder<List<EventTicket>>(
